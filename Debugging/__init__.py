...
-------------------------------------------------------------------------------
INTRODUCTION
This test plan addresses debugging test coverage for the 4.x series of 
...
2.0:     Tests implemented for IronPython under mdbg. Scenarios which still 
         ...
         * Step into/out when there is no pdb file for IP 
           binaries
         * Multiple statements in one line (e.g., "x = 1;y=4"
         * if x and \\n y: print 1
...
- OPERATING SYSTEMS
  ...
  64_86-bit Windows 7
  32-bit Windows 8
  64_86-bit Windows 10
  64_86-bit Windows 11
- NETWORKS
...
- SOFTWARE
  * Visual Studio 2020 Team System Service Pack 1 installed to run the 
    test suite
